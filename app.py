...
from services.mlb_service import get_team_details, get_team_roster, get_transactions, get_player_stats
...
def player_stats():
    ...
    if year == "2025":
        ...
        if not players_param:
            player_ids = [p["mlbId"] for p in players_collection.find({}, {"mlbId": 1})]
        else:
